...
Pa2Rep2<-carms.arrow(Pa2Rep2, from=1, to=2, rate="2*B1", arc=.35, label="2*B1")
Pa2Rep2<-carms.arrow(Pa2Rep2, from=2, to=1, rate="B2", arc=.35, label="B2")
Pa2Rep2<-carms.arrow(Pa2Rep2, from=2, to=3, rate="B1", arc=.35, label="B1")
Pa2Rep2<-carms.arrow(Pa2Rep2, from=3, to=2, rate="2*B2", arc=.35, label="2*B2")

dev.new(width=11, height=7, unit="in")
diagram(Pa2Rep2)

# usage: simulate.carms(x, solution, mission_time, intervals=50, cycles=2000)
Pa2Rep2<-simulate.carms(Pa2Rep2, "bd", mission_time=.5, intervals=50)
